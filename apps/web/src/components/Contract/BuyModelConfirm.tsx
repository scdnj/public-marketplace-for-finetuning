...
import { buyWeight } from "../../service/weightMarket/contract";
import KamuiLoading from '../Loading/KamuiLoading'
...
const BuyModelConfirm = ({ modelId, onClose }: VoteContent) => {
    ...
    const handleBuy = async () => {
        try {
            setIsLoading(true)
            const r = await buyWeight(modelId)
            setIsLoading(false)
            setProcess(true)
        } catch (error) {
            setIsLoading(false)
...
export default BuyModelConfirm
